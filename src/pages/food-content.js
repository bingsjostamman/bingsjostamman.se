export default {
  ...
  hero: {
    ...
    slots: [
      ...
      {
        type: "markdown",
        text: "Ät en bit mat och häng på puben vid Bystugan eller fika vid Danielsgården. Eller förse dig hos lokala lanthandeln."
      }
    ],
    imageOptions: {
      lqipId: "2026/bystuga-cafe_jcslj3"
    }
  },
  intro: `
